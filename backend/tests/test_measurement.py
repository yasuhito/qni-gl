...
class TestMeasurement(unittest.TestCase):
    ...
    def test_build_circuit(self):
        ...
        assert str(circuit[0].operations[0]) == "cirq.MeasurementGate(1, cirq.MeasurementKey(name='m0_0'), ())(q(0))"
    ...
    def test_build_circuit_with_two_measurement_gates(self):
        ...
        assert str(circuit[0].operations[0]) == "cirq.MeasurementGate(1, cirq.MeasurementKey(name='m0_0'), ())(q(0))"
        assert str(circuit[0].operations[1]) == "cirq.MeasurementGate(1, cirq.MeasurementKey(name='m0_1'), ())(q(1))"
        assert str(measurements) == "[{'key': 'm0_0', 'target_bit': 0}, {'key': 'm0_1', 'target_bit': 1}]"
    ...
    def test_build_circuit_with_consecutive_measurement_gates(self):
        ...
        assert str(circuit[0].operations[0]) == "cirq.MeasurementGate(1, cirq.MeasurementKey(name='m0_0'), ())(q(0))"
        assert str(circuit[1].operations[0]) == "cirq.MeasurementGate(1, cirq.MeasurementKey(name='m1_2'), ())(q(2))"
        assert str(circuit[2].operations[0]) == "cirq.MeasurementGate(1, cirq.MeasurementKey(name='m2_1'), ())(q(1))"
        assert (
            str(measurements)
            == "[{'key': 'm0_0', 'target_bit': 0}, {'key': 'm1_2', 'target_bit': 2}, {'key': 'm2_1', 'target_bit': 1}]"
        )
