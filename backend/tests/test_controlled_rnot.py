...
class TestControlledRnot(unittest.TestCase):
    def setUp(self):
        self.qiskit_runner = QiskitRunner()

    def test_controlled_rnot_00(self):
    ...
    def test_controlled_rnot_01(self):
        ...
        assert_complex_approx(amplitudes[1], 0.5, 0.5)
        assert_complex_approx(amplitudes[2], 0, 0)
        assert_complex_approx(amplitudes[3], 0.5, -0.5)

    def test_controlled_rnot_10(self):
    ...
    def test_controlled_rnot_11(self):
    ...
    def test_controlled_rnot_2_controls_000(self):
    ...
    def test_controlled_rnot_2_controls_011(self):
        ...
        assert_complex_approx(amplitudes[5], 0, 0)
        assert_complex_approx(amplitudes[6], 0, 0)
        assert_complex_approx(amplitudes[7], 0.5, -0.5)

    def test_controlled_rnot_1_control_2_targets(self):
    ...
    def test_controlled_rnot_1_control_2_targets_011(self):
        ...
        amplitudes = result[1]["amplitudes"]
        assert_complex_approx(amplitudes[0], 0, 0)
        assert_complex_approx(amplitudes[1], 0, 0.5)
        assert_complex_approx(amplitudes[2], 0, 0)
        assert_complex_approx(amplitudes[3], 0.5, 0)
        assert_complex_approx(amplitudes[4], 0, 0)
        assert_complex_approx(amplitudes[5], 0.5, 0)
        assert_complex_approx(amplitudes[6], 0, 0)
        assert_complex_approx(amplitudes[7], 0, -0.5)
