...
class TestControlledS(unittest.TestCase):
    def setUp(self):
        self.qiskit_runner = QiskitRunner()

    def test_controlled_s_00(self):
    ...
    def test_controlled_s_01(self):
        steps = [
            [{"type": "X", "targets": [0]}],
            [{"type": "S", "targets": [1], "controls": [0]}],
        ]
    ...
    def test_controlled_s_2_controls_000(self):
    ...
    def test_controlled_s_2_controls_011(self):
        steps = [
            [{"type": "X", "targets": [0, 1]}],
            [{"type": "S", "targets": [2], "controls": [0, 1]}],
        ]
    ...
    def test_controlled_s_1_control_2_targets(self):
    ...
    def test_controlled_s_1_control_2_targets_011(self):
        steps = [
            [{"type": "X", "targets": [0]}],
            [{"type": "S", "targets": [1, 2], "controls": [0]}],
        ]
